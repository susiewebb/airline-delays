...
dw_edit_chart(
  ...
  intro = paste0("<b>Total Cancellations:</b>",totals$`Total cancellations within, into, or out of the United States today`,"<br><span style='font-size: 18px;line-height: 26px;'><b>
